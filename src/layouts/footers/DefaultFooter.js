  ...
  return (
    ...
    {data ?<footer className="footer-style-one">
        ...
        <div className="container">
            ...
            <div className="footer-first" style={{
                ...
                <div className="contact-info d-flex-all">
                    ...
                    <p>{appDataLanguage.footer.call_us} <span>+(502) 2215-7376</span></p>
                </div>
                <Link href="/contact" className="theme-btn">
                {appDataLanguage.footer.call_us} <i className="fa-solid fa-angles-right" />
                </Link>
            </div>
            </div>
        </div>
        ...
        <div className="container">
                ...
                <div className="footer-col">
                    ...
                    <ul>
                        <li>
                            ...
                            <p>{appDataLanguage.footer.info.address}</p>
                        </li>
                        <li>
                            ...
                            <p>{appDataLanguage.footer.info.tel}</p>
                        </li>
                        <li>
                            ...
                            <p>{appDataLanguage.footer.info.email}</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    ...
                    <form action={appDataLanguage.settings.mailchimp.url} method="post" target="_blank">
                        <input type="email" name="EMAIL" placeholder="Enter your email." required />
                        <input type="hidden" name={appDataLanguage.settings.mailchimp.key} />
                        <button type="submit">
        ...
        <div className="container">
            <div className="row">
            <div className="footer-col">
                <p dangerouslySetInnerHTML={{ __html: appDataLanguage.footer.copy }} />
